...
public enum TransitionOption{
    ...
    GIVECLASS("giveClass",true),					/// Give the player the specified class(if they don't already have one):
    ...
    DOCOMMANDS("doCommands",true),					/// Run a list of commands as either the console or player
